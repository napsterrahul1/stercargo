...
class Loading extends Model
{
    //
    protected $table = 'prs';
    protected $fillable = ['date','vehicle_number','vendor_name','hire_amount','docket','client_id','receiver_name','boy_name','total_docket','amount_to_be_collected','total_weight','origin','destination'];
