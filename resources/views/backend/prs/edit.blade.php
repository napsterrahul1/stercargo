                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{translate('Vehicle No.')}}" name="vehicle_number"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{translate('Vendor Name')}}" name="vendor_name"
                                           class="form-control" required value="{{ $shipment->vendor_name }}"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{translate('Vehicle Hire Amount')}}:</label>
                                    <input type="text" placeholder="{{translate('Vehicle Hire Amount')}}"
                                           name="hire_amount" class="form-control" required value="{{ $shipment->hire_amount }}"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{translate('Receiver Name')}}"
                                           name="Shipment[receiver_name]" value="{{ $shipment->receiver_name }}" class="form-control"/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{translate('Pick up Boy Name')}}"
                                           name="Shipment[reciver_phone]" value="{{ $shipment->boy_name }}" class="form-control"/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{translate('Total Docket Number')}}"
                                           name="Shipment[total_docket]" value="{{ $shipment->total_docket }}" class="form-control"/>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="kt_touchspin_3" placeholder="{{translate('Amount to be Collected')}}"
                                               type="text" min="0" class="form-control" value="{{$shipment->amount_to_be_collected}}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="kt_touchspin_4" placeholder="{{translate('Total Weight')}}"
                                               type="text" min="1" class="form-control total-weight" value="{{$shipment->total_weight}}"
