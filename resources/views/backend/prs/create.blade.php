...
<div class="mx-auto col-lg-12">
    <div class="card">
        ...
        <form class="form-horizontal" action="{{ route('admin.prs.store') }}" id="kt_form_1" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <option value="{{$docket->id}}">{{$docket->code}}</option>               @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
