...
@section('sub_title'){{translate('PRS')}} {{$shipment->code}}@endsection
@section('subheader')
    <!--begin::Subheader-->
        ...
        <div class="flex-wrap container-fluid d-flex align-items-center justify-content-between flex-sm-nowrap">
            ...
            <div class="flex-wrap mr-1 d-flex align-items-center">
                ...
                <div class="flex-wrap mr-5 d-flex align-items-baseline">
                    <!--begin::Page Title-->
                    <h5 class="my-1 mr-5 text-dark font-weight-bold">{{translate('PRS')}} {{$shipment->code}}</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
        ...
        <div class="px-8 py-8 row justify-content-center pt-md-27 px-md-0">
            <div class="col-md-10">
                <div class="pb-10 d-flex justify-content-between pb-md-20 flex-column flex-md-row">
                    <div class="px-0 d-flex flex-column align-items-md-start">
                        <span class="d-flex flex-column align-items-md-start">
                            <h1 class="mb-10 display-4 font-weight-boldest">{{translate('PRS')}}: {{$shipment->code}}</h1>
                ...
                <div class="pt-6 d-flex justify-content-between">
                    <div class="d-flex flex-column flex-root">
                        <span class="mb-2 font-weight-bolder">{{translate('Vehicle Number')}}</span>
                        <span class="opacity-70">{{$shipment->vehicle_number}}</span>
                    </div>
                    <div class="d-flex flex-column flex-root">
                        <span class="mb-2 font-weight-bolder">{{translate('Vendor Name')}}</span>
                        <span class="opacity-70">{{$shipment->vendor_name }}</span>
                    </div>
                    <div class="d-flex flex-column flex-root">
                        <span class="mb-2 font-weight-bolder">{{translate('Hire Amount')}}</span>
                        <span class="opacity-70">{{$shipment->hire_amount }}</span>
                    </div>
        ...
        <div class="px-8 py-8 row justify-content-center py-md-10 px-md-0">
            <div class="col-md-10">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="{{route('admin.prs.edit', $shipment->id)}}" class="px-6 py-3 btn btn-light-info btn-sm font-weight-bolder font-size-sm">{{translate('Edit PRS')}}</a>
                    @endif
                </div>
            </div>
        </div>
