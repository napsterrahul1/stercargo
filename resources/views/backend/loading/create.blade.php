...
<div class="mx-auto col-lg-12">
    <div class="card">
        ...
        <form class="form-horizontal" action="{{ route('admin.loading.store') }}" id="kt_form_1" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{translate('Loading Staff Name')}}" name="Shipment[boy_name]" class="form-control" />
