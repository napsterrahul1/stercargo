...
@section('sub_title'){{translate('Loading')}}@endsection
@section('subheader')
    <!--begin::Subheader-->
        ...
        <div class="flex-wrap container-fluid d-flex align-items-center justify-content-between flex-sm-nowrap">
            ...
            <div class="flex-wrap mr-1 d-flex align-items-center">
                ...
                <div class="flex-wrap mr-5 d-flex align-items-baseline">
                    <!--begin::Page Title-->
                    <h5 class="my-1 mr-5 text-dark font-weight-bold">{{translate('Loading')}}</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="p-0 my-2 mr-5 breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold font-size-sm">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="#" class="text-muted">Loading</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                    <a href="{{ route('admin.loading.create') }}" class="btn btn-light-primary font-weight-bolder btn-sm"><i class="flaticon2-add-1"></i> {{translate('Add New Loading')}}</a>
            ...
            <div class="mb-7">
                <div class="row align-items-center">
                    ...
                    <div class="mt-5 col-lg-3 col-xl-12 mt-lg-0 d-flex">
                        ...
                        <a href="{{route('admin.prs.export', $status)}}" class="ml-auto px-6 btn btn-light-primary font-weight-bold">{{translate('Export loading')}}</a>
                    </div>
