...
@section('sub_title'){{translate('Loading Sheet')}}@endsection
@section('subheader')
    <!--begin::Subheader-->
        ...
        <div class="flex-wrap container-fluid d-flex align-items-center justify-content-between flex-sm-nowrap">
            ...
            <div class="flex-wrap mr-1 d-flex align-items-center">
                ...
                <div class="flex-wrap mr-5 d-flex align-items-baseline">
                    <!--begin::Page Title-->
                    <h5 class="my-1 mr-5 text-dark font-weight-bold">{{translate('Loading Sheet')}}</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="p-0 my-2 mr-5 breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold font-size-sm">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="#" class="text-muted">Loading Sheet</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                    <a href="{{ route('admin.loading.create') }}" class="btn btn-light-primary font-weight-bolder btn-sm"><i class="flaticon2-add-1"></i> {{translate('Add New Loading Sheet')}}</a>
                    @if(in_array($auth_user->user_type ,['customer']))
                        <a href="{{ route('admin.loading.import') }}" class="ml-3 btn btn-light-primary font-weight-bolder btn-sm">{{translate('Import Shipments')}}</a>
                    @endif
                </div>
                <!--end::Page Heading-->
            </div>
                ...
                <div class="mb-7">
                    <div class="row align-items-center">
                        ...
                        <div class="mt-5 col-lg-3 col-xl-12 mt-lg-0 d-flex">
                            ...
                            <a href="{{route('admin.loading.export', $status)}}" class="ml-auto px-6 btn btn-light-primary font-weight-bold">{{translate('Export Loading Sheet')}}</a>
                        </div>
                    ...
                    <tr>
                        ...
                        @if($status != "all")
                            <td class="text-center">
                                ...
                                <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('admin.loading.show', $shipment->id)}}" title="{{ translate('Show') }}">
                                ...
                                {{--@if($status != \App\Shipment::APPROVED_STATUS && $status != \App\Shipment::CAPTAIN_ASSIGNED_STATUS && $status != \App\Shipment::CLOSED_STATUS && $status != \App\Shipment::RECIVED_STATUS && $status != \App\Shipment::IN_STOCK_STATUS && $status != \App\Shipment::DELIVERED_STATUS && $status != \App\Shipment::SUPPLIED_STATUS && $status != \App\Shipment::RETURNED_STATUS )--}}
                                    <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('admin.loading.edit', $shipment->id)}}" title="{{ translate('Edit') }}">
