...
@csrf
        ...
        <div class="card-body ">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="code" class="form-control"
                               placeholder="{{translate('Docket No')}}" name="code" value="{{$client->code}}" readonly>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="invoice_no" class="form-control"
                               placeholder="{{translate('Invoice No')}}" name="invoice_no" value="{{$client->invoice_no}}" readonly>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="invoice_no" class="form-control"
                               placeholder="{{translate('Invoice Value')}}" name="invoice_value" value="{{$client->invoice_value}}" readonly>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select name="from_source" style="display: block !important;"
                            class="change-area-client-address form-control" disabled>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="sender"
                               placeholder="{{translate('sender')}}" name="sender" value="{{$client->sender}}" readonly>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="{{translate('Receiver')}}"
                               name="receiver" value="{{$client->receiver}}" readonly>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="billing_party"
                               placeholder="{{translate('Billing Party')}}" name="billing_party" value="{{$client->billing_party}}" readonly>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="{{translate('Product')}}"
                               name="product" value="{{$client->product}}" readonly>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="description"
                               placeholder="{{translate('Description')}}" name="description" value="{{$client->description}}" readonly>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control fright" placeholder="{{translate('PCS')}}" name="pcs" id="pcs" value="{{$client->pcs}}" readonly>
                    </div>
                </div>
                <div class="col-md-3">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control fright" placeholder="{{translate('Actual Weight')}}" name="actual_weight" value="{{$client->actual_weight}}" readonly>
            </div>
            </div>
                <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control fright" placeholder="{{translate('Charge Weight')}}"
                       name="charge_weight" id="charge_weight" value="{{$client->charge_weight}}" readonly>
            </div>
            </div>
                <div class="col-md-6">
            <div class="form-group">
                <label>{{translate('Varai/Hamali Charge/Loading Unloading Charge')}}:</label>
                <input type="text" class="form-control" placeholder="{{translate('Charge')}}" name="charge" value="{{$client->charge}}" readonly>
            </div>
            </div>
                <div class="col-md-3">
            <div class="form-group">
                ...
                <select name="calc_on" style="display: block !important;"
                        class="change-area-client-address form-control" id="calc_on" disabled>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control fright" placeholder="{{translate('Freight Rate')}}" name="freight_rate" id="freight_rate" value="{{$client->freight_rate}}" readonly>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control"  placeholder="{{translate('Freight Amount')}}" name="freight_amount" id="freight_amount" value="{{$client->fright_amount}}" readonly>
                    </div>
                </div>
                     <div class="col-md-3">
            <div class="form-group">
                <label>{{translate('FOV')}}:</label>
                <input type="number" class="form-control" placeholder="{{translate('FOV')}}" name="FOV" min="0.0" max="100" id="fov" value="{{$client->FOV}}" readonly>
            </div>
            </div>
                <div class="col-md-3">
            <div class="form-group">
                <label>{{translate('Fuel')}}:</label>
                <input type="number" class="form-control" min="0.0" max="100" placeholder="{{translate('Fuel')}}" name="fuel" id="fuel" value="{{$client->fuel}}" readonly>
            </div>
            </div>
                  <div class="col-md-3">
                    <div class="form-group">
              ...
              <input type="number" min="0" class="form-control finalamount" placeholder="{{translate('Here')}}" name="LR_charge" id="lr_charges" value="{{$client->LR_charge}}" readonly>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>{{translate('ODA Charge')}}({{currency_symbol()}}):</label>
    <input type="number" min="0" class="form-control finalamount" placeholder="{{translate('Here')}}" name="oda_charge" id="oda_charge" value="{{$client->oda_charge}}" readonly>
                            </div>
                        </div>
                        <div class="form-group col-md-3">
                            ...
                            <input type="number" min="0" id="door_dly_charge" class="form-control finalamount"
                                   ...
                                   name="door_dly_charge" value="{{$client->door_dly_charge}}" readonly>
                        </div>
            ...
            <div class="mb-0 text-right form-group">
                <a href="{{url('admin/dockets')}}" class="btn btn-sm btn-primary">{{translate('Back')}}</a>
            </div>
        </div>
    </form>
