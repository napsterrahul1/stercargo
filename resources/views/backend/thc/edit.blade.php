            ...
            <div class="flex-wrap mr-1 d-flex align-items-center">
                ...
                <div class="flex-wrap mr-5 d-flex align-items-baseline">
                    ...
                    <ul class="p-0 my-2 mr-5 breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold font-size-sm">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="#" class="text-muted">{{ translate('Edit THC') }}</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
...
@section('sub_title'){{translate('Edit New THC')}}@endsection
@php
    $auth_user = Auth::user();
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        @endphp
                                        <input type="text" placeholder="{{translate('THC Date')}}" name="Shipment[date]" autocomplete="off" class="form-control" id="kt_datepicker_3" value="{{ $shipment->date }}" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{translate('THC Number')}}" name="Shipment[thc_number]" class="form-control"  value="{{ $shipment->thc_number }}"/>
                        ...
                        @endif
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{translate('Vendor Name')}}" name="Shipment[vendor_name]" class="form-control" value="{{ $shipment->vendor_name }}"/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{translate('Vehicle Number')}}" name="Shipment[vehicle_number]" class="form-control" value="{{$shipment->vehicle_number}}"/>
                        ...
                        <option value="1" {{$shipment->vehicle_type == 1 ? 'selected' : '' }}>6 FEET</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{translate('Hire Amount')}}" name="Shipment[hire_amount]" class="form-control" value="{{ $shipment->hire_amount }}"/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{translate('Advance Amount')}}" name="Shipment[advance_amount]" class="form-control" value="{{ $shipment->advance_amount }}"/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{translate('Balance Amount')}}" name="Shipment[balance_amount]" class="form-control" value="{{ $shipment->balance_amount }}"/>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="kt_touchspin_3" placeholder="{{translate('Total Package')}}" type="text" min="0" class="form-control"  name="Shipment[total_package]" value="{{$shipment->total_package}}"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="kt_touchspin_4" placeholder="{{translate('Total Weight')}}" type="text" min="1" class="form-control total-weight" name="Shipment[total_weight]" value="{{$shipment->total_weight}}" />
                                    </div>
                                </div>
